@php
    $attributes = $attributes->merge(['xmlns' => 'http://www.w3.org/2000/svg']);
@endphp
...
@elseif ($name === 'telegram')
    <svg viewBox="0 0 496 512" {{ $attributes }}>
        <path
...
@elseif ($name === 'chevron-left')
    <svg viewBox="0 0 320 512" {{ $attributes }}>
        <path
...
@elseif ($name === 'exclamation-triangle')
