            ...
            <form action="{{ route('login') }}" method="POST" class="flex flex-col gap-4">
                ...
                <div class="flex items-center gap-3 grow">
                    <input type="checkbox" name="remember" value="1" id="remember"
                           {{ old('remember') ? 'checked' : '' }} class="size-5 rounded-md border-gray-300 text-violet-600 focus:border-violet-300 focus:ring focus:ring-violet-200 focus:ring-opacity-50 focus:ring-offset-0">
                    <label class="font-medium" for="remember">Remember me</label>
                </div>
