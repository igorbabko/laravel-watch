    ...
    <section class="pt-32 px-10">
        <div class="container flex flex-col gap-8 pb-24">
            ...
            <div class="flex items-start gap-8">
                <div class="flex flex-col sticky top-24 w-1/4">
                    <form action="{{ route('courses.index') }}" class="flex flex-col gap-6">
                        ...
                        <div class="flex gap-2">
                            ...
                            <button
                                class="whitespace-nowrap rounded-md font-semibold px-4 py-2 bg-violet-500 text-white hover:bg-violet-600 grow">
                                Search
                            </button>
                        </div>
                    </form>
