...
<html lang="en">
    ...
    <body>
        <header class="fixed w-full bg-purple-600 text-white z-10">
            <nav>
                <div class="container mx-auto flex justify-between items-center py-2">
                    ...
                    <ul class="flex gap-6">
                        ...
                        <li>
                            <a href="#" class="font-medium text-purple-100 hover:text-white text-lg">Login &rarr;</a>
                        </li>
{{--                        <li>--}}
        ...
        <main>
            <section>
                <div class="container mx-auto h-screen flex justify-center items-center flex-col gap-6">
                    <h1 class="text-7xl font-black text-center drop-shadow-lg">Learn <span
                            class="text-pink-500">Web</span> Development</h1>
